...
public class Algorithms {
    ...
    public static class ComparatorGen implements Comparator<Chromosome> {
        @Override
    ...
    //positive if o2 > o1
    public static class ComparatorGreed implements Comparator<Item> {
        @Override
    ...
    public static Chromosome order(int capacity, ArrayList<Item> items) {
    ...
    private static List<Chromosome> selection(List<Chromosome> population, List<Item> items, int capacity) {
    ...
    public static List<Item> greedy(int capacity, ArrayList<Item> items) {
